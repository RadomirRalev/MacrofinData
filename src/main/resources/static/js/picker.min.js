...
!function (t, i, e, n) {
    ...
    r.prototype = {
        defaults: {
            ...
            coloring: {},
            limit: n,
            texts: {trigger: "Select value", noResult: "No results", search: "Search"}
            ...
            var e = t(i.target), n = e.parent().data("id"), r = e.parent().data("order"),
            ...
            var e = t(i.target).val().toLowerCase(), n = this._filterData(e);
            ...
            for (s = 0; s < this.currentData.length; s++) if (0 == s) {
                if (r < this.currentData[s].order || 1 == this.currentData.length) {
                    this.currentData.splice(0, 0, {id: n, text: e.parent().text(), order: r});
                    break
                }
            } else if (s == this.currentData.length - 1) {
                if (r > this.currentData[s].order) {
                    this.currentData.splice(s, 0, {id: n, text: e.parent().text(), order: r});
                    break
                }
            ...
            var i = this.$elem.find("option:eq(0)").text(), e = i ? i : this.config.texts.trigger;
            ...
            return this.currentData.filter(function (i) {
                return i.text.toLowerCase().indexOf(t) != -1
            })
